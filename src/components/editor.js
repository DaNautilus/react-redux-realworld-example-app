...
class Editor extends React.Component {
  constructor() {
    ...
    const updateFieldEvent = key => event => this.props.onUpdateField(key, event.target.value);
    ...
    this.submitForm = ev => {
      ...
      const promise = this.props.articleSlug ?
        Articles.update(Object.assign(article, slug)) :
  ...
  componentWillReceiveProps(nextProps) {
    if (this.props.match.params.slug !== nextProps.match.params.slug) {
      if (nextProps.match.params.slug) {
        this.props.onUnload();
        return this.props.onLoad(Articles.get(this.props.match.params.slug));
      }
